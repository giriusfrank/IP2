...
namespace CustomADT
{
    ...
    class SkipList::SkipListImpl
    {
        ...
        public:
            ...
            std::string toString() const
            {
                ...
                while (curr)
                {
                    oss << curr->value << " "; curr = curr->forward[0];
                }
                return oss.str();
            }
    };
    ...
    {
        if (this != &other) pImpl->deepCopy(*(other.pImpl));
        return *this;
    }
    ...
    SkipList& SkipList::operator%=(const EditOp& edit)
    {
        pImpl->remove(edit.oldValue);
        pImpl->insert(edit.newValue);
        return *this;
    }
